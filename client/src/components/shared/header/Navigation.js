...
function Navigation() {
  return (
    <div
			className="sticky md:hidden z-49 bottom-2  p-1 px-2 m-6     bg-white   dark:bg-gray-900 shadow-3xl text-gray-500 rounded-2xl cursor-pointer">
        ...
        <SearchFilter />
			...
			<div className="flex flex-col items-center  hover:text-blue-400 ">
				<div
					...
					<span
                            className="animate-ping  border-blue-500 absolute inline-flex h-full w-full rounded-full border-4 opacity-50"></span>
				</div>
			</div>
