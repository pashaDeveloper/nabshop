            ...
            <div className="flex items-center mt-14 justify-center text-center">
              <div className="text-gray-700 mt-6 md:mt-0">
                <p>
                  ...
                  >
                    <span className="text-2xl"> {blog?.creator?.name}</span>
                  </a>
                </p>
                  ...
                  {!blog?.comments ? (
                    ...
                    blog?.comments.map((comment, index) => (
                      ...
                      >
                        ...
                        {/* نمایش پاسخ‌ها */}
                        {blog?.comment.replies && blog?.comment.replies.length > 0 && (
                          <div className="mt-4 ml-6">
                            {blog?.comment.replies.map((reply, replyIndex) => (
                              <div
